...
import { GraduationCap, Target, TrendingUp, Star, Users, Award, ChevronRight, BookOpen, Clock } from 'lucide-react-native';
        ...
        <View style={styles.heroSection}>
          ...
          <View style={styles.heroContent}>
            ...
            <Text style={styles.heroDescription}>
              Transform your relationship with money through expert-crafted micro-lessons. 
              Build wealth, reduce stress, and achieve financial freedom.
            </Text>
        ...
        <View style={styles.quickStatsSection}>
          <View style={styles.quickStatsContainer}>
            <View style={styles.quickStatCard}>
              ...
              <Text style={styles.quickStatDesc}>Building financial confidence</Text>
            </View>
            <View style={styles.quickStatCard}>
              <Clock size={24} color={colors.accent} />
              <Text style={styles.quickStatTitle}>15-min lessons</Text>
              <Text style={styles.quickStatDesc}>Perfect for busy schedules</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.coursesSection}>
          <View style={styles.sectionHeader}>
            ...
            <Text style={styles.sectionDescription}>
              Master essential financial skills through our structured learning paths. 
              Each course builds upon the previous, creating a comprehensive financial education.
            </Text>
          </View>
        ...
        <View style={styles.featuresSection}>
          ...
          <View style={styles.featuresGrid}>
            <View style={styles.featureCard}>
              ...
              <Text style={styles.featureCardDesc}>Complete lessons in 15 minutes or less</Text>
            </View>
            <View style={styles.featureCard}>
              <Target size={28} color={colors.secondary} />
              <Text style={styles.featureCardTitle}>Practical Focus</Text>
              <Text style={styles.featureCardDesc}>Real-world strategies you can use today</Text>
            </View>
            <View style={styles.featureCard}>
              <Star size={28} color={colors.accent} />
              <Text style={styles.featureCardTitle}>Expert Content</Text>
              <Text style={styles.featureCardDesc}>Created by financial professionals</Text>
            </View>
            <View style={styles.featureCard}>
              <TrendingUp size={28} color={colors.warning} />
              <Text style={styles.featureCardTitle}>Track Progress</Text>
              <Text style={styles.featureCardDesc}>Monitor your financial learning journey</Text>
            </View>
          </View>
        </View>
      </ScrollView>
